    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div v-else class="modal-body p-0">
          ...
          <div class="p-3 bg-light">
            ...
            <div class="card shadow-sm border-0">
              ...
              <div class="card-body">
                ...
                <div class="text-primary mb-2"><i class="fas fa-building me-2"></i>The Company</div>
          ...
          <!-- File Preview -->
          <div v-if="selectedFile" class="border-top p-3">
            <h6 class="mb-3"><i class="fas fa-code me-2"></i>Uploaded File Preview</h6>
            <div class="bg-dark text-light p-3 rounded">
              <code class="text-light">
                <i :class="fileType === 'html' ? 'fab fa-html5' : 'fab fa-js'" class="me-2"></i>{{ fileName }}
              </code>
              <p class="text-muted small mt-2 mb-0">File will be loaded in a secure sandbox for testers</p>
            </div>
          </div>
